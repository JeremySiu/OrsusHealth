    ...
    <div className="relative w-full h-full flex flex-col pt-6 pb-2 px-6">
      ...
      <div className="absolute top-0 left-[-9999px]">
        <div 
          ...
          style={{ width: '794px', minHeight: '1123px', padding: '48px', boxSizing: 'border-box', fontFamily: 'system-ui, sans-serif' }}
        >
          {/* Header */}
          <div className="flex justify-between items-start border-b border-zinc-200 pb-6 mb-8">
            <div>
               ...
               <p className="text-zinc-500 mt-1">Generated by OrsusHealth AI Analysis Engine</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-8 mb-10">
            ...
            <div className="bg-white p-6 border border-zinc-200 rounded-xl shadow-sm">
              <h2 className="text-lg font-bold border-b border-zinc-100 pb-2 mb-4 flex items-center gap-2">
                <User className="w-5 h-5 text-teal-600" /> Patient Profile
              </h2>
              <ul className="space-y-3 text-sm">
                <li className="flex justify-between"><span className="text-zinc-500 font-medium">Full Name</span> <span className="font-semibold text-zinc-900">{formData.FullName || "Not Provided"}</span></li>
                <li className="flex justify-between"><span className="text-zinc-500 font-medium">Age</span> <span className="font-semibold text-zinc-900">{formData.Age} Years</span></li>
                <li className="flex justify-between"><span className="text-zinc-500 font-medium">Biological Sex</span> <span className="font-semibold text-zinc-900">{formData.Sex === 'M' ? 'Male' : 'Female'}</span></li>
                <li className="flex justify-between"><span className="text-zinc-500 font-medium">Resting Blood Pressure</span> <span className="font-semibold text-zinc-900">{formData.RestingBP || "N/A"} mmHg</span></li>
                <li className="flex justify-between"><span className="text-zinc-500 font-medium">Cholesterol</span> <span className="font-semibold text-zinc-900">{formData.Cholesterol || "N/A"} mg/dl</span></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-10">
            <h2 className="text-xl font-bold text-zinc-800 mb-6 flex items-center gap-2 border-b border-zinc-200 pb-2">
            ...
            <div className="space-y-6">
              {features.map((item, idx) => {
                ...
                const displayLabel = featureLabelMap[item.feature] || item.feature;
                 ...
                 return (
                   <div key={idx} className="break-inside-avoid bg-white p-5 rounded-xl border border-zinc-200">
                     ...
                     <div className="bg-teal-50 border-l-4 border-teal-500 p-3 mb-3 rounded-r-md">
                       <p className="text-sm text-teal-900">
                         <strong>Recommendation:</strong> {clinicalData.suggestion}
                       </p>
                     </div>
          ...
          <div className="mt-12 text-center text-xs text-zinc-400 pt-6 border-t border-zinc-200">
